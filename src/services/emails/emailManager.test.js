...
const directoriesTable = [['email-templates/'], ['a/b/'], ['']]
...
describe('Emails Manager test suite', () => {
  ...
  test('20 - error validating html template', async () => {
    const err = {
      ...
      code: 'InvalidXml',
      details: `Error on template file email-templates/MagicLink/en.html. Extra text at the end on line 18`,
