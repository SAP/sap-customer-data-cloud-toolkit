...
export const expectedFullAccount = [
  ...
  },
  {
    ...
    value: false,
    branches: [
      { id: 'addresses.soldTo', name: 'soldTo', value: false, branches: [{ id: 'addresses.soldTo.entrance', name: 'entrance', value: false, branches: [] }] },
      { id: 'addresses.shipTo', name: 'shipTo', value: false, branches: [{ id: 'addresses.shipTo.apartment', name: 'apartment', value: false, branches: [] }] },
    ],
    switchId: 'object',
  },
  {
  ...
  },
  {
    ...
    value: false,
    branches: [
      { id: 'C_Email', name: 'C_Email', value: false, branches: [{ id: 'communications.C_Email.status', name: 'status', value: false, branches: [] }] },
      { id: 'T_Email', name: 'T_Email', value: false, branches: [{ id: 'communications.T_Email.status', name: 'status', value: false, branches: [] }] },
      {
        id: 'C_mobileApp',
        name: 'C_mobileApp',
        value: false,
      ...
      { id: 'C_whatsApp', name: 'C_whatsApp', value: false, branches: [{ id: 'communications.C_whatsApp.status', name: 'status', value: false, branches: [] }] },
      { id: 'T_SMS', name: 'T_SMS', value: false, branches: [{ id: 'communications.T_SMS.status', name: 'status', value: false, branches: [] }] },
      {
        id: 'C_SMS',
        name: 'C_SMS',
        value: false,
