...
class FullAccount extends AccountManager {
  ...
  #genericFullAccountDataflow(successNextStep) {
    return {
      name: '{{dataflowName}}',
      status: 'published',
      description: 'Import Full Account - Toolkit',
      steps: [
        ...AccountManager.commonTransformCDCStructure('loginIds'),
        ...
        ...AccountManager.errorFile(successNextStep, AccountType.Full),
        ...
        ...AccountManager.commonImportAccountRequestLogger('gigya.importaccount'),
        {
        ...
        ...AccountManager.successFile(successNextStep, AccountType.Full),
        {
