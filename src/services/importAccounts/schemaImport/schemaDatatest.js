...
export const expectedSchemaLiteResponse = [
  {
    id: 'profile',
    name: 'profile',
    value: false,
    ...
    branches: [
      {
        ...
        name: 'soldTo',
        value: false,
        branches: [{ id: 'addresses.soldTo.entrance', name: 'entrance', value: false, branches: [] }],
      },
      {
        id: 'addresses.shipTo',
        name: 'shipTo',
        value: false,
        branches: [{ branches: [], id: 'addresses.shipTo.apartment', name: 'apartment', value: false }],
      },
    ],
    switchId: 'object',
  },
