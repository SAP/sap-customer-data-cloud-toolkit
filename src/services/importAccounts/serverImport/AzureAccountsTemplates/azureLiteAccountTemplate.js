 ...
 "steps": [
  {
   ...
   "next": [
    "04. Transform Subscriptions"
   ]
  },
  {
   "id": "01. Read azure.blob",
  ...
  {
   "id": "07. gigya.generic - ImportLiteAccount",
   ...
   "next": [
    "08. Import Account Success Response"
   ],
   "error": [
    "07.1 Import Account Error Response"
   ]
  },
  {
   "id": "08. Import Account Success Response",
   "type": "record.evaluate",
   "params": {
  ...
  {
   "id": "07.1 Import Account Error Response",
   "type": "record.evaluate",
   "params": {
  ...
  {
   "id": "06. Import Account Request Logger",
   "type": "record.evaluate",
   "params": {
   ...
   "next": [
    "07. gigya.generic - ImportLiteAccount"
   ]
  },
  {
   "id": "09. Success File",
  ...
  },
  {
   ...
   "next": [
    "06. Import Account Request Logger"
   ]
  }
 ],
 "version": 1
