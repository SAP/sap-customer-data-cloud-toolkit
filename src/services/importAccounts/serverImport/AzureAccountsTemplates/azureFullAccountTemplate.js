export const azureFullAccountTemplate = `
 ...
 "steps": [
  ...
  },
  {
   ...
   "next": [
    "6.1 If UID is Present",
    "6. If UID Is Not Present"
   ]
  },
  {
   "id": "6.2 Account lookup using UID",
  ...
  {
   "id": "9. Import Account Request Logger",
   "type": "record.evaluate",
   "params": {
  ...
  {
   "id": "8. Handle unsupported schema",
   "type": "record.evaluate",
   "params": {
   ...
   "next": [
    "9. Import Account Request Logger"
   ]
  },
  {
  ...
  },
  {
   ...
   "next": [
    "6.2 Account lookup using UID"
   ]
  },
  {
   "id": "6. If UID Is Not Present",
   "type": "record.evaluate",
   "params": {
