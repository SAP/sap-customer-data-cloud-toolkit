...
describe('Info Email Templates test suite', () => {
  ...
  test('get emails info successfully only magicLink', async () => {
    ...
    expectedResponse[4].branches.splice(10, 1)
    expectedResponse[4].branches.splice(9, 1)
    expectedResponse[4].branches.splice(8, 1)
    expectedResponse[4].branches.splice(7, 1)
    expectedResponse[4].branches.splice(6, 1)
    expectedResponse[4].branches.splice(5, 1)
    expectedResponse[4].branches.splice(4, 1)
    expectedResponse[4].branches.splice(3, 1)
    expectedResponse[4].branches.splice(2, 1)
    expectedResponse[4].branches.splice(1, 1)
