...
import { ROUTE_CONTAINER_CLASS, ROUTE_COPY_CONFIG_EXTENDED, ROUTE_EMAIL_TEMPLATES, ROUTE_SITE_DEPLOYER, ROUTE_SMS_TEMPLATES, ROUTE_PRETTIER, buildUrl } from './inject/constants'
...
function App() {
  ...
  console.log('urlPararms', buildUrl())
  return (
    <ThemeProvider>
      <div className="App">
