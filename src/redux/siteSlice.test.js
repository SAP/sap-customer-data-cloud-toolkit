...
test('should update parent site Base Domain', () => {
	const updatedParent = sitesReducer(
		stateWithParentWithNoChild,
		updateParentBaseDomain(parentToUpdate),
	).sites[0]
...
test('should update parent site Description', () => {
	const updatedParent = sitesReducer(
		stateWithParentWithNoChild,
		updateParentDescription(parentToUpdate),
	).sites[0]
...
test('should update parent site Data Center', () => {
	const updatedParent = sitesReducer(
		...
		updateParentDataCenter(parentToUpdate),
	).sites[0]
...
test('should update child site Base Domain', () => {
	const updatedChild = sitesReducer(
		stateWithParentWithChild,
		updateChildBaseDomain(childToUpdate),
	).sites[0].childSites[0]
...
test('should update child site Description', () => {
	const updatedChild = sitesReducer(
		stateWithParentWithChild,
		updateChildDescription(childToUpdate),
	).sites[0].childSites[0]
