...
const RiskBasedAuthenticationRulesButtons = ({ treeNode, setRbaRulesOperation, t }) => {
  ...
  return (
    <span>
      <Select className="ui5-content-density-compact" onChange={(event) => handleRadioButtonChange(event, treeNode, setRbaRulesOperation, dispatch)} value="" valueState="None">
