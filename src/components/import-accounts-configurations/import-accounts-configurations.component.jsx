...
const SiteConfigurations = ({ configurations, handleSelectChange, setSwitchOptions, setConfigurationStatus, selectedTreeNodeId, treeNodeInputValue, expandableNode, t }) => {
