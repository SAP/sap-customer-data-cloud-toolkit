...
const { menuElements, initMenuExtension, destroyMenuExtension, injectMenu } = require('./injectMenu')
...
it('CDC Toolbox menu buttons injected when Admin Button exists and removed when it desappears', () => {
  ...
  adminButton = document.querySelector('.fd-nested-list__icon.sap-icon--action-settings').parentNode
